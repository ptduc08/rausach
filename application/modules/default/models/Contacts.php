<?php
class Default_Model_Contacts extends Zend_Db_Table {
	...
	public function saveItem($arrParam = null, $options = null) {
		if ($options['task'] == 'admin-contact-add') {
			$row 				= $this->fetchNew();
			$row->contact_title 	= $arrParam['contact_title'];
			$row->contact_name 	= $arrParam['contact_name'];
			$row->contact_address 	= $arrParam['contact_address'];
			$row->email			= $arrParam['contact_email'];
			$row->mobile		= $arrParam['contact_mobile'];
			$row->contact_content	= $arrParam['contact_content'];
			$row->publish		= 1;
			$row->lock_status	= 1;
