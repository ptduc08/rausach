<?php
class Default_Block_BlkTourAbroadCategory extends Zend_View_Helper_Abstract {
	
	public function blkTourAbroadCategory() {
		$blockView = $this->view;
		...
		require_once (DEFAULT_BLOCK_PATH . '/BlkTourAbroadCategory/default.php');
	}
}