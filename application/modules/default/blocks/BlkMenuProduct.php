<?php
class Default_Block_BlkMenuProduct extends Zend_View_Helper_Abstract {

	public function blkMenuProduct() {
		...
		$MenuProduct = $db->fetchAll($select);
		//$result[0] = '-- Select a Category --';
		//----- sap xep lai mang $result theo khoa
		ksort($MenuProduct);


		require_once (DEFAULT_BLOCK_PATH . '/BlkMenuProduct/default.php');
