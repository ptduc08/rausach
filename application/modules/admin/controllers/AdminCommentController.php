<?php
class Admin_AdminCommentController extends Zendvn_Controller_Action {
	...
	public function indexAction() {
		...
		$tblComment = new Admin_Model_Comment();		
		$allComment = $tblComment->getAllItem();
		$this->view->Items = $allComment;
		/*
	...
	public function infoAction() {
		...
		$tblComment = new Admin_Model_Comment();
		$thisComment = $tblComment->getItem($this->_arrParam,array('task'=>'admin-comment-info'));		
		
		$this->view->Item = $thisComment;
	}
