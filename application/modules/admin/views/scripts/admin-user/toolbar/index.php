<?php 
	...
	//------------- nut Edit Yourself - kieu link
	$linkEditYourselfItem = $this->baseUrl($this->currentController . '/edit-yourself');
	$btnEditYourselfItem = $this->cmsButton($this->translate('button-edit'),$linkEditYourselfItem,
			$this->imgUrl . '/toolbar/icon-32-edit.png','link');
	...
	switch ($this->arrParam['action']) {
		...
		case 'edit':
			...
			break;
		case 'edit-yourself':
			$linkSaveItem = $this->baseUrl($this->currentController . '/edit-yourself');
			break;
		default:
			$linkSaveItem = '';
	}
