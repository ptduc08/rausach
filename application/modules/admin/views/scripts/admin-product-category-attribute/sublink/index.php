...
<div id="submenu-box">
	<div style="border:1px solid #CCCCCC; padding:5px">
		<ul id="submenu">
			...
			<li>
				<a href="#" class="active"><?php echo $this->translate('sublink-productcategoryattribute'); ?></a>
			</li>
			<li>
				<a href="<?php echo $linkProductManager; ?>"><?php echo $this->translate('sublink-product'); ?></a>
			</li>
		</ul>
		<div class="clr"></div>
	</div>
