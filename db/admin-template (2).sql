...
--
-- Host: localhost
-- Generation Time: Oct 01, 2014 at 05:37 AM
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `product_assessment` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_guarantee` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_model` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_guarantee_policy` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `product_price_new` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `view_counter` int(111) NOT NULL,
  PRIMARY KEY (`id`)
...
(48, 'dien thoai ip6', 'ip6 ve vn', 'gia ip6', 'projectimage_1412111975542b1e6743ef1.jpg', 0, 1, 78, 0, 50, '2014-10-01 04:19:35', 50, '2014-10-01 04:19:35', 50, '2014-10-01 04:19:45', 0, 14);
...
(50, 'admin', 'useravatar_1368085709518b54cd964a2.jpg', '5f4dcc3b5aa765d61d8327deb882cf99', 'administrator@ocdc.com.vn', 'Administrator', 'OCDC', '2013-05-09', '2013-05-09 14:05:29', '113.179.16.238', NULL, NULL, NULL, 1, '', 1),
(51, 'trandat', 'useravatar_141179222054263d5c42de2.jpg', '5f4dcc3b5aa765d61d8327deb882cf99', 'trandat@example.com', 'dat', 'tran', '1989-01-10', '2014-09-27 11:09:20', '::1', NULL, NULL, NULL, 0, 'fix code php', 4),
(52, 'ptduc08', 'useravatar_141179228754263d9f4ba43.jpg', '5f4dcc3b5aa765d61d8327deb882cf99', 'ptduc08@example.com', 'duc', 'pt', '1989-01-10', '2014-09-27 11:09:27', '::1', NULL, NULL, NULL, 0, 'aa', 3),
(53, 'member', 'useravatar_141179232854263dc8c6dd3.jpg', '5f4dcc3b5aa765d61d8327deb882cf99', 'member@example.com', 'mem', 'ber', '1989-01-10', '2014-09-27 11:09:09', '::1', NULL, NULL, NULL, 1, 'bb', 5);
