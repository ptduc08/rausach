...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2014 at 03:46 AM
...
(58, 'Ủng - Găng tay - Thảm cách điện cao thế', 'Ủng - Găng tay - Thảm cách điện cao thế', '', 68, '2013-04-06 13:04:45', 43, '2014-10-31 23:09:55', 50, 3, 0, 0, 1, 50, '2014-10-31 23:09:55'),
(59, 'Bình cứu hỏa', 'Bình cứu hỏa', '', 60, '2013-04-06 14:04:06', 43, '2014-10-31 23:09:15', 50, 2, 0, 0, 1, 50, '2014-10-31 23:09:15'),
(60, 'Phòng cháy chữa cháy', 'Phòng cháy chữa cháy', '', 0, '2013-04-06 14:04:24', 43, '2014-11-10 09:07:40', 50, 10, 0, 0, 1, 50, '2014-11-10 09:07:40'),
(67, 'Bình chữa cháy', 'Bình chữa cháy', '', 60, '2013-08-25 16:48:13', 50, '2014-10-31 23:08:53', 50, 40, 0, 0, 1, 50, '2014-11-10 08:57:48'),
(68, 'mien bac', 'mien bac', '', 0, '2014-11-10 08:58:51', 50, '2014-11-10 08:58:51', 50, 41, 0, 1, 1, 50, '2014-11-10 08:58:51'),
(69, 'mien nam', 'mien nam', '', 0, '2014-11-10 09:06:59', 50, '2014-11-10 09:06:59', 50, 42, 0, 1, 1, 50, '2014-11-10 09:06:59'),
(70, 'mien nam', 'mien nam', '', 60, '2014-11-10 09:06:59', 50, '2014-11-10 09:06:59', 50, 42, 0, 1, 1, 50, '2014-11-10 09:06:59'),
(71, 'Bình chữa cháy', 'Bình chữa cháy', '', 69, '2013-08-25 16:48:13', 50, '2014-10-31 23:08:53', 50, 40, 0, 0, 1, 50, '2014-11-10 08:57:48'),
(72, 'Bình chữa cháy', 'Bình chữa cháy', '', 69, '2013-08-25 16:48:13', 50, '2014-10-31 23:08:53', 50, 40, 0, 0, 1, 50, '2014-11-10 08:57:48'),
(73, 'Bình chữa cháy', 'Bình chữa cháy', '', 69, '2013-08-25 16:48:13', 50, '2014-10-31 23:08:53', 50, 40, 0, 0, 1, 50, '2014-11-10 08:57:48'),
(74, 'Bình chữa cháy', 'Bình chữa cháy', '', 69, '2013-08-25 16:48:13', 50, '2014-10-31 23:08:53', 50, 40, 0, 0, 1, 50, '2014-11-10 08:57:48'),
(75, 'Bình chữa cháy', 'Bình chữa cháy', '', 60, '2013-08-25 16:48:13', 50, '2014-10-31 23:08:53', 50, 40, 0, 0, 1, 50, '2014-11-10 08:57:48');
...
--
-- Indexes for table `log_client_access`
--
ALTER TABLE `log_client_access`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `news_category_article`
--
ALTER TABLE `news_category_article`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `category_article` (`category_id`,`article_id`);
...
--
-- Indexes for table `product_category_attribute`
--
...
ALTER TABLE `user_group_privileges`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `privilege_group` (`privilege_id`,`group_id`);
...
--
-- AUTO_INCREMENT for table `log_client_access`
--
ALTER TABLE `log_client_access`
...
--
-- AUTO_INCREMENT for table `news_category_article`
--
ALTER TABLE `news_category_article`
...
--
-- AUTO_INCREMENT for table `product_category_attribute`
--
ALTER TABLE `product_category_attribute`
